...
#LOCAL DB
#DATABASE_HOST = "kuali2.cc.lehigh.edu"
DATABASE_HOST = "localhost"
DATABASE_USERNAME = "folio"
DATABASE_PASSWORD = "folio123"
DATABASE_PORT = 5432
#DATABASE_PORT = 1111
DATABASE_NAME = "indexdata_folio_prod"
TENANT = "lu"
			...
			try: 
				...
				for record in JSONReader(marcJsonAsString):
					...
					for holding in holdingRows:
						...
						#print("-------------------HOLDING")
						#print(holding['permanentlocationid'])
